...
import edu.neu.csye6200.inheritTest.MeterManager;
...
public class PlantRoster {
	...
	public void displayPlant(){
		...
		System.out.println(String.format("%1$-16s %2$-16s %3$-16s %4$-16s %5$-16s %6$-16s %7$-16s", "SpecimenID", "Plant Name", "Age(Year)",
				"Length(cm)", "Width(cm)", "flowerColor", "PetalNumbers"));		
